...
public class DashboardController {
    ...
    @ResponseBody
    public BaseResponse recentPosts() { return BaseResponse.buildSuccess(aurArticleInfoService.recentPosts()); }
    ...
    @GetMapping("/labels")
    @ResponseBody
    public BaseResponse labels() { return BaseResponse.buildSuccess(aurArticleLabelService.labels()); }
}
